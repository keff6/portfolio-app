...
/**
 * GitHub icon component using inline SVG.
 * 
 * @param props - Component props
 * @param props.size - Icon size in pixels (default: 20)
 * @param props.className - Additional CSS classes
 * @returns SVG element for GitHub icon
 */
...
/**
 * LinkedIn icon component using inline SVG.
 * 
 * @param props - Component props
 * @param props.size - Icon size in pixels (default: 20)
 * @param props.className - Additional CSS classes
 * @returns SVG element for LinkedIn icon
 */
...
/**
 * Renders the footer with social links and copyright notice.
 * 
      ...
      <div className="max-w-4xl mx-auto text-center">
        <div className="flex justify-center gap-6 mb-6">
          ...
          <a
            ...
            aria-label="GitHub"
          >
            <GithubIcon size={20} className="text-gray-400 hover:text-white" />
          </a>
        </div>
